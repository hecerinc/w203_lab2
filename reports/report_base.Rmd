...
```{r Unemployment vs CPI, warning=FALSE, error=FALSE, echo=FALSE, message=FALSE}
## Unemployment + CPI
...
```{r Exploring unemployment rate data, warning=FALSE, error=FALSE, echo=FALSE, message=FALSE, results='hide'}
...
```{r Unemployment vs approval rating, warning=FALSE, error=FALSE, echo=FALSE, message=FALSE}
