...
Even though we are basing our response variable `Y` from the adjusted approval ratings by different weights, we are trusting on the weight calculation and factoring done by Five Thirty-Eight and Gallup. We are aware of the `polester house effect` and trusting the mechanism put by these organisations to ensure survey integrity.
