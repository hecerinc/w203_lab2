...
```{r EDA for WTI, warning=FALSE, error=FALSE, echo=FALSE}
summary(df$gas)
...
```{r Approval rating vs gas, echo=FALSE, warning=FALSE}
...
```{r Exploratory charts for CPI, warning=F, error=F, echo=FALSE}
...
```{r Unemployment vs CPI, echo=FALSE, warning=FALSE}
## Unemployment + CPI
...
```{r Exploring unemployment rate data, error=F, warning=F, echo=FALSE}
...
```{r Unemployment vs approval rating, echo=FALSE, warning=FALSE}
...
```{r Model results, results='asis', warning=FALSE, echo=FALSE}
