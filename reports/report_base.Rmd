...
**True Model       :** $$\text{approval\_rating} = \beta_0 + \beta_1 \text{gas\_price} + \beta_2 \text{cpi} + \beta_3 \text{unemployment\_rate} + \beta_4 \text{immigration} + \ldots + \beta_i presidents_i +\ldots + \beta_j event_j$$

**Approximate Model    :** $$\text{approval\_rating} = \tilde{\beta}_0 + \tilde{\beta}_1 \text{gas\_price} + \tilde{\beta}_2 \text{cpi} + \tilde{\beta}_3 \text{unemployment\_rate} + \ldots + \beta_i presidents_i +\ldots + \beta_j event_j$$
...
![Direction Analysis for OVB: cpi](./Image02_OVB_Immigration.png)
...
**True Model       :** $$\text{approval\_rating} = \beta_0 + \beta_1 \text{gas\_price} + \beta_2 \text{cpi} + \beta_3 \text{unemployment\_rate} + \beta_4 \text{natural\_disaster} + \ldots + \beta_i presidents_i +\ldots + \beta_j event_j$$
...
![Direction Analysis for OVB: cpi](./Image03_OVB_Natural_Disaster.png)
