...
approval <- read.csv('../data/raw/approval_topline.csv', header=T) # Approval Rating
gas <- read.csv('../data/raw/dcoilwtico.csv')                      # Crude Oil Prices: West Texas Intermediate (WTI)
```
...
## Combine Y with Xs
df <- left_join(approval, combined_indvars, by = 'date')  # Full data
```
